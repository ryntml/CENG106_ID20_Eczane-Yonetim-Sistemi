...
public class EczaciGiris extends JFrame {
    ...
    private void initializeUI() {
        ...
        girisBtn.addActionListener(e -> {
            ...
            if (eczaciService.girisYap(kullaniciAdi, sifre)) {
                JOptionPane.showMessageDialog(this, "Giriş başarılı!");
                Eczaci eczaci = eczaciService.getEczaci(kullaniciAdi); // <-- BURADA TANIMLANIYOR!
                EczaciMenu eczaciMenu = new EczaciMenu(eczaci);
                eczaciMenu.setVisible(true);
                this.dispose();
           }else {
